...
/**
 * Set all 64 Fire pads to pink color
...
function setAllPadsPink(midiOut) {
  console.log('Setting all 64 pads to pink (R=100 G=0 B=100)...');
  
  // Send pink color to all pads
  const padData = [];
  for (let i = 0; i < 64; i++) {
    padData.push(i, 100, 0, 100); // padIndex, red=100, green=0, blue=100 (max intensity)
  }
  ...
  console.log('All 64 pads set to pink (R=100 G=0 B=100)!');
